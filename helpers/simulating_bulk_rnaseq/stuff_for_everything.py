...
def simulate_data(
    ...
    sample_index = pd.Index([f"{name}/sample_{i:03d}" for i in range(n)], name="sample_id")
    ...
    bulk_rnaseq, cell_type_geps = make_mixtures(sc_rnaseq, sc_metadata, sampled_fractions, rng=rng)
