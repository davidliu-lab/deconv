...
tcga_skcm_fractions_mets = NotImplemented
...
def run_trial(
    ...
    path_data_prefix = cloudpathlib.AnyPath(f"gs://liulab/evaluating_cibersortx/identical_cohorts/{trial_id}")
    ...
    uri_results_fractions = str(path_results_prefix / "csx_results" / "fractions")
    ...
    running_cibersortx.sigmatrix_and_fractions.run_fractions_and_upload(uri_pseudobulks, uri_refsample_sc_rnaseq, uri_results_fractions)
    running_cibersortx.hires_with_fractions.run_and_upload(
        uri_save_job_files_to=,
        uri_bulk_rnaseq=uri_pseudobulks,
        uri_sigmatrix=uri_sigmatrix,
        uri_sourcegeps=uri_sourcegeps,
    )
